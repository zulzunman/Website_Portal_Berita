            ...
            <div class="col">
                <nav class="navbar navbar-expand-lg bg-body-tertiary rounded-bottom-4">
                    <div class="container-fluid">
                        ...
                        <!-- Logo -->
                        <div class="col h1">
                            <a href="<?=base_url()?>"><img class="title" src="<?php echo base_url('style/IMG_3889.PNG'); ?>" alt="Kiarajangkung"></a>
                            <!-- <h2><a class="navbar-brand" href="beranda.html"><img class="title" src="/style/IMG_3889.PNG" alt="Kiarajangkung"> Kiarajangkung</a></h2> -->
