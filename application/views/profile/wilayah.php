...
<head>
    ...
    <title>Wilayah Desa Kiarajangkung</title>
</head>
        ...
        <div class="row pt-4 pb-4">
            ...
            <div class="col">
                ...
                <div class="row pt-2 pb-2">
                    <h2>Keadaan Geografis</h2>
                    <p align="justify" class="fs-5">
                        <text> Desa Kiarajangkung adalah salah satu dari 7 (tujuh) desa yang ada di Kecamatan
                            Sukahening.
                            Secara Geografis letak Desa Kiarajangkung adalah termasuk Wilayah Tasik Utara Barat yang
                            berbatasan langsung dengan Kehutanan/ Hutan Lindung yang berbatasan langsung dengan
                            Kabupaten
                            Garut.
                    </p>
                </div>
                ...
                <!--Data Detail-->
                <p class="fs-4">A. Batas Wilayah :

                    <li class="fs-5" style="text-indent: 0.3in;">Sebelah Utara : Desa Kertamukti Kec. Ciawi</li>
                    <li class="fs-5" style="text-indent: 0.3in;">Sebelah Selatan : Desa Sundakerta</li>
                    <li class="fs-5" style="text-indent: 0.3in;">Sebelah Timur : Desa Sukahening</li>
                    <li class="fs-5" style="text-indent: 0.3in;">Sebelah Barat : Kehutanan / Kab. Garut</li>
                </p>
                <p class="fs-4">B. Luas Wilayah :

                    <li class="fs-5" style="text-indent: 0.3in;">Luas Wilayah : 331,54 ha</li>
                    <li class="fs-5" style="text-indent: 0.3in;">Luas Pesawahan : 120 ha</li>
                    <li class="fs-5" style="text-indent: 0.3in;">Luas Kehutanan / Hutan Lindung : 180 ha </li>
                    <li class="fs-5" style="text-indent: 0.3in;">Luas Tanah Darat : 211,54 ha</li>
                    <li class="fs-5" style="text-indent: 0.3in;">Luas Hutan Rakyat / Kebun : 166 ha</li>
                    <li class="fs-5" style="text-indent: 0.3in;">Luas Jalan Irigasi, Pemakaman dll : 6 Ha</li>
                </p>
                <p class="fs-4">C. Kondisi Geologis :

                    <li class="fs-5" style="text-indent: 0.3in;">Ketinggian dari permukaan air laut : 853 M
                    <li class="fs-5" style="text-indent: 0.6in; list-style:none;">S = 07’12’01’0’’</li>
                    <li class="fs-5" style="text-indent: 0.6in; list-style:none;"> E = 10’07’45’5’’</li>
                    </li>
                    <li class="fs-5" style="text-indent: 0.3in;">Suhu udara rata-rata : 18º - 210 C</li>
                    <li class="fs-5" style="text-indent: 0.3in;">Curah Hujan Rata-rata pertahun : 2.994 mm </li>
                    <li class="fs-5" style="text-indent: 0.3in;">Keberadaan Air yang bersumber dari pegunungan dengan
                        jumlah cukup</li>
                </p>
                <p class="fs-4">D. Kondisi Topografis :

                    <li class="fs-5" style="text-indent: 0.3in;">Pwgunungan : 65%</li>
                    <li class="fs-5" style="text-indent: 0.3in;">Lembah dan Dataran : 35%</li>
