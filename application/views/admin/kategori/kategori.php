    ...
    <div class="container-fluid">
        ...
        <div class="row py-4">
            ...
            <div class="col-md-9 ps-5 py-5">
                <div class="row">
                    <h2>Data Kategori<span class="float-end"><a href="<?=site_url('admin/addk')?>" style="color: #ffffff"><button type="button" class="btn btn-primary">Tambah Kategori</button></a></span></h2>
                    <hr>
                ...
                <div class="row mx-5 px-5">
                    <table class="table table-striped table-bordered p-2">
                        ...
                        <tbody class="table-group-divider">
                            ...
                            <tr>
                                ...
                                <td><?=$data->nama?></td>
                                <?php if( $type=$this->session->userdata('tipe')=='Admin' ) { ?>
                                    <td align="center"><a href="<?=site_url('admin/updatek/'.$data->id_kat)?>"><i class="fa-solid fa-pen-to-square bg-warning p-2 text-white rounded"></i></a></td>
                                    <td align="center"><a href="<?=site_url('admin/delk/'.$data->id_kat)?>"onclick="return confirm('Are you sure?')"><i class="fa-solid fa-trash bg-danger p-2 text-white rounded"></i></a></td>
                                <?php } ?>
                            </tr>
                            <?php } ?>
                        </tbody>
                    ...
                    <a href="<?=site_url('admin')?>" style="color: #ffffff"><button type="button" class="btn btn-primary">Back Home</button></a>
                </div>
            </div>
            <!-- Ads -->
            <div class="col-md-1"></div>
