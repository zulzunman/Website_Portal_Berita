                    ...
                    <div class="col-md-9 ps-5 py-5">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="kategori-wrapper">
                                <div class="row">
                                        <label class="form-label"><h4>Kategori 1</h4></label>
                                    <div class="col-md-3 mb-3">
                                        <input type="text" name="nama[]" value="<?=$nama?>" id="nama validationDefault01" class="form-control" required>
                                    </div>
                                    <?php 
                                    if ($nama) {
                                        echo '<div class="col-md-3 mb-3">
                                                <button type="button" class="btn btn-primary" id="add-kategori" hidden disabled>Tambah Kategori</button>
                                            </div>';
                                    } else {
                                        echo '<div class="col-md-3 mb-3">
                                                <button type="button" class="btn btn-primary" id="add-kategori">Tambah Kategori</button>
                                            </div>';
                                    }
                                    ?>
                                </div>
                            ...
                            <a href="<?=site_url('admin/readk')?>" style="color: #ffffff"><button type="button" class="btn btn-primary">Back</button></a>
                        </form>
                    </div>
                    <div class="col-md-1"></div>
                </div>
        ...
        $(document).ready(function() {
            ...
            $("#add-kategori").click(function() {
                var kategoriHtml = '<div class="row">' + 
                                        '<label class="form-label"><h4>Kategori' + kategori +'</h4></label>' + 
                                    '<div class="col-md-3 mb-3">' + 
                                        '<input type="text" name="nama[]" id="nama '+ kategori +' validationDefault01" class="form-control" required>' + 
                                    '</div>' + 
                                    '<div class="col-md-3 mb-3">' + 
                                        '<button type="button" class="btn btn-danger" id="del-kategori">Hapus Kategori</button>' + 
                                    '</div>' + 
                                '</div>';
                $(".kategori-wrapper").append(kategoriHtml);
                kategori++;
            });
            $(document).on('click', '#del-kategori', function(){
                --kategori;
