    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-9 ps-5 py-5">
                <h2><i class="fa-solid fa-key"></i> GANTI PASSWORD</h2><hr> 
                ...
                <form action="" method="post">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="password" name="newpassword" class="form-control" placeholder="Masukan password baru" required>
                    </div>
                    <input type="submit" name="change" class="btn btn-primary" value="GANTI PASSWORD"></input>
