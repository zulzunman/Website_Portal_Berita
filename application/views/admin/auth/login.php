    ...
    <div class="container-fluid">
        ...
        <div class="row py-4 justify-content-center align-items-center text-center">
            ...
            <div class="col">
                <!-- Article -->
                <div class=" container-fluid">
                    <div class="row d-grid justify-content-center align-items-center text-center">
                        ...
                        <form action="" method="post">
                            ...
                            <input type="submit" class="btn btn-primary mb-4" name="login" value="LOGIN"></input>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <!-- <div class="container col-md-3 position-absolute top-50 start-50 translate-middle p-3 rounded" align="center" style="background-color: #007a99;">
        </div> -->
