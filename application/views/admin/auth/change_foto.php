...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-1"></div>
            <div class="col-md-10 ps-5 py-5">
                <h2><i class="fa-solid fa-clipboard-user"></i> GANTI FOTO</h2><hr> 
                <?=$this->session->flashdata('msg')?>
                <div style="color: red;"><?=$error?></div>
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="col-md-3 mb-3">
                        <label class="form-label">FOTO SEKARANG</label>
                        <img src="<?=base_url('uploads/users/'.$this->session->userdata('foto'))?>" width="250" height="250" class="rounded mx-auto d-block">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label for="formFile" class="form-label"><i class="fa-solid fa-images"></i> FOTO BARU</label>
                        <input class="form-control" name="foto" type="file" id="formFile" required>
                    </div>
                    <input type="submit" class="btn btn-primary" name="upload" value="UNGGAH FOTO"></input>
