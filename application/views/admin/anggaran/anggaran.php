...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="row py-4">
            ...
            <div class="col-md-1"></div>
            <!-- Content -->
            <div class="col-md-9 ps-5 py-5">
                <div class="row">
                    <h2>Data Pemasukan<span class="float-end"><a href="<?=site_url('admin/addam')?>" style="color: #ffffff"><button type="button" class="btn btn-primary"><i class="fa-solid fa-plus bg-primary p-2 text-white rounded"></i>Tambah Pemasukan</button></a></span></h2>
                    <hr>
                ...
                <div class="row mx-5 px-5">
                    <table class="table table-striped table-bordered p-2">
                        ...
                        <tbody class="table-group-divider">
                            <?php $i=1; foreach($anggaran as $data) {
                            ...
                            <tr>
                                ...
                                <td><a href="<?=site_url('admin/updateam/'.$data->ida)?>"><i class="fa-solid fa-pen-to-square bg-warning p-2 text-white rounded"></i></a></td>
								<td><a href="<?=site_url('admin/dela/'.$data->ida)?>" onclick="return confirm('Are you sure?')"><i class="fa-solid fa-trash bg-danger p-2 text-white rounded"></i></a></td>
                            </tr>
                            <?php } } ?>
                        </tbody>
                        <br>
                ...
                <br><br>
                <div class="row">
                    <h2>Data Pengeluaran<span class="float-end"><a href="<?=site_url('admin/addak')?>" style="color: #ffffff"><button type="button" class="btn btn-primary"><i class="fa-solid fa-plus bg-primary p-2 text-white rounded"></i>Tambah Pengeluaran</button></a></span></h2>
                    <hr>
                </div>
                <div class="row mx-5 px-5">
                    <table class="table table-striped table-bordered p-2">
                        ...
                        <tbody class="table-group-divider">
                            ...
                            <tr>
                                ...
                                <td><?=$data->nama?></td>
                                <td>Rp <?=number_format($data->jumlah, 2,',','.');?></td>
                                <td><a href="<?=site_url('admin/updateak/'.$data->ida)?>"><i class="fa-solid fa-pen-to-square bg-warning p-2 text-white rounded"></i></a></td>
								<td><a href="<?=site_url('admin/dela/'.$data->ida)?>" onclick="return confirm('Are you sure?')"><i class="fa-solid fa-trash bg-danger p-2 text-white rounded"></i></a></td>
                            </tr>
                            <?php } } ?>
                        </tbody>
                    ...
                    <table class="table table-striped table-bordered p-2">
                        ...
                        <tbody class="table-group-divider">
                            <tr>
                                ...
                                <td>Rp <?=number_format($masuk, 2,',','.');?></td>
                            </tr>
                            <tr>
                                <td align="center" style="font-weight: bold;">2</td>
                                <td>Jumlah Pengeluaran</td>
                                <td>Rp <?=number_format($keluar, 2,',','.');?></td>
                            </tr>
                        </tbody>
                        <tfoot>
                            <tr>
                                <th colspan="2" align="center">Total Saldo</th>
                                <th>Rp <?=number_format($saldo, 2,',','.');?></th>
                            </tr>
                        </tfoot>
                        <br>
                    </table>
                    <a href="<?=site_url('admin')?>" style="color: #ffffff"><button type="button" class="btn btn-primary">Back</button></a>
                </div>
            </div>
            <!-- Ads -->
            <div class="col-md-1"></div>
