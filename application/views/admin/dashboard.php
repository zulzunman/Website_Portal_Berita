        ...
        <div class="row py-4">
            ...
            <div class="col py-3">
                ...
                <div class="row float-center">
                    <div class="col">
                        <div class="card ms-3 my-1 bg-primary" style="width: 18rem;">
                            <div class="card-body">
                                <h3 class="card-title"><i class="fa-solid fa-newspaper"></i> Berita</h3>
                                <h5><a class="nav-link" aria-current="page" href="<?= site_url('admin/readb') ?>">Kelola Berita</a></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                    <?php if( $type=$this->session->userdata('tipe')=='Admin' ) { ?>
                        <div class="card ms-3 my-1 bg-primary" style="width: 18rem;">
                            <div class="card-body">
                                <h3 class="card-title"><i class="fa-solid fa-layer-group"></i> Kategori</h3>
                                <h5><a class="nav-link" aria-current="page" href="<?= site_url('admin/readk') ?>">Kelola Kategori</a></h5>
                            </div>
                        </div>
                    <?php } ?>
                    </div>
                    ...
                    <?php if( $type=$this->session->userdata('tipe')=='Admin' ) { ?>
                        <div class="card ms-3 my-1 bg-primary" style="width: 18rem;">
                            <div class="card-body">
                                <h3 class="card-title"><i class="fa-solid fa-money-bills"></i> Anggaran</h3>
                                <h5><a class="nav-link" aria-current="page" href="<?= site_url('admin/reada') ?>">Kelola Anggaran</a></h5>
                            </div>
                        </div>
                    <?php } ?>
                    </div>
                ...
                <div class="row">
                    <?php if( $type=$this->session->userdata('tipe')=='Author' ) { ?>
                    <div class="col">
                        <div class="card ms-3 my-1 bg-warning" style="width: 18rem;">
                            <div class="card-body">
                                <h3 class="card-title"><i class="fa-solid fa-user"></i> User</h3>
                                <h5><a class="nav-link" aria-current="page" href="<?=site_url('user/update_data/'.$this->session->userdata('nik'))?>">Edit Profile</a></h5>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
                    ...
                    <div class="col">
                        <div class="card ms-3 my-1 bg-warning" style="width: 18rem;">
                            <div class="card-body">
                                <h3 class="card-title"><i class="fa-solid fa-user"></i> User</h3>
                                <h5><a class="nav-link" aria-current="page" href="<?=site_url('user')?>">Kelola User</a></h5>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
                    <div class="col">
                        <div class="card ms-3 my-1 bg-warning" style="width: 18rem;">
                            <div class="card-body">
                                <h3 class="card-title"><i class="fa-solid fa-camera"></i> Foto</h3>
                                <h5><a class="nav-link" aria-current="page" href="<?= site_url('auth/changefoto') ?>">Ganti Foto</a></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        ...
                        <div class="card ms-3 my-1 bg-warning" style="width: 18rem;">
                            <div class="card-body">
                                <h3 class="card-title"><i class="fa-solid fa-users"></i> Personil</h3>
                                <h5><a class="nav-link" aria-current="page" href="<?= site_url('admin/readp') ?>">Kelola Personil</a></h5>
                            </div>
                        </div>
                        <?php } ?>
                    </div>
                ...
                <div class="row">
                    <div class="col">
                        <div class="card ms-3 my-1 bg-danger" style="width: 18rem;">
                            <div class="card-body">
                                <h3 class="card-title"><i class="fa-solid fa-key"></i> Password</h3>
                                <h5><a class="nav-link" aria-current="page" href="<?= site_url('auth/changepass') ?>">Ganti Password</a></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card ms-3 my-1 bg-danger" style="width: 18rem;">
                            <div class="card-body">
                                <h3 class="card-title"><i class="fa-solid fa-right-from-bracket"></i> Logout</h3>
                                <h5><a class="nav-link" aria-current="page" href="<?= site_url('auth/logout') ?>">Keluar</a></h5>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        ...
                        <div class="col">
                            ...
                            <div class="table-responsive">
                                <iframe
                                    ...
                                    height="250" width="500" style="border:0;" allowfullscreen loading="lazy" referrerpolicy="no-referrer-when-downgrade">
                                </iframe>
                            </div>
                        </div>
