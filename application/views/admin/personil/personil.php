    ...
    <div class="container-fluid">
        ...
        <div class="row py-4">
            ...
            <div class="col-md-9 ps-5 py-5">
                <div class="row">
                    <h2>Data Personil<span class="float-end"><a href="<?=site_url('admin/addp')?>" style="color: #ffffff"><button type="button" class="btn btn-primary"><i class="fa-solid fa-plus bg-primary p-2 text-white rounded"></i>Tambah Personil</button></a></span></h2>
                    <hr>
                    ...
                    <table class="table table-striped table-bordered p-2">
                        ...
                        <tbody class="table-group-divider">
                            ...
                            <tr>
                                ...
                                <td><a href="<?=site_url('admin/updatep/'.$data->idp)?>"><i class="fa-solid fa-pen-to-square bg-warning p-2 text-white rounded"></i></a></td>
								<td><a href="<?=site_url('admin/delp/'.$data->idp)?>" onclick="return confirm('Are you sure?')"><i class="fa-solid fa-trash bg-danger p-2 text-white rounded"></i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                        <br>
