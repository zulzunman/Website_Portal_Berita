    ...
    <div class="container-fluid">
        ...
        <div class="row py-4">
            ...
            <div class="col-md-9 ps-5 py-5">
                <div class="row">
                    <h2>Data User<span class="float-end"><a href="<?=site_url('user/simpan_data')?>" style="color: #ffffff"><button type="button" class="btn btn-primary"><i class="fa-solid fa-plus bg-primary p-2 text-white rounded"></i>Tambah User</button></a></span> <span class="float-end mx-2"><a class="nav-link" aria-current="page" href="<?=site_url('user/update_data/'.$this->session->userdata('nik'))?>"><button type="button" class="btn btn-warning"><i class="fa-solid fa-user bg-warning p-2 text-white rounded"></i> Edit Profile</button></a></span></h2>
                    <hr>
                    ...
                    <table class="table table-striped table-bordered p-2">
                        ...
                        <tbody class="table-group-divider">
                            ...
                            <tr>
                                ...
                                <td><img src="<?=base_url('uploads/'.$data->foto)?>" width=100px alt=""></td>
                                <td><?=$data->nik?></td>
                                <td><?=$data->nama?></td>
                                <td><?=$data->gender?></td>
                                <td><?=$data->tipe?></td>
                                <td><?=$data->no_hp?></td>
                                <td><?=$data->alamat?></td>
                                <td><a href="<?=site_url('user/reset/'.$data->nik)?>" onclick="return confirm('Are you sure reset password?')"><i class="fa-solid fa-unlock bg-warning p-2 text-white rounded"></i></a></td>
								<td><a href="<?=site_url('user/delete/'.$data->nik)?>" onclick="return confirm('Are you sure?')"><i class="fa-solid fa-trash bg-danger p-2 text-white rounded"></i></a></td>
                            </tr>
                            <?php } ?>
                        </tbody>
                        <br>
